...
.then((data) => {
    data.articles.map((e, i) => {
        ...
        cardDiv.innerHTML += `<div class="card mb-3 text-center" style="width: 18rem; height:200px border-radius: 12px; background-color: #fff; box-shadow: rgba(0, 0, 0, 0.16) 0px 10px 36px 0px, rgba(0, 0, 0, 0.06) 0px 0px 0px 1px; transition: transform 0.3s ease;">
...
// let search = () => {
//   const API_KEY = `https://newsapi.org/v2/everything?q=karachi&from=2024-11-09&sortBy=publishedAt&apiKey=b6d72b8f1a084f0d9ab2ca83d042c7fc
// `;
//   fetch(API_KEY)
//     .then((res) => res.json())
//     .then((data) => {
